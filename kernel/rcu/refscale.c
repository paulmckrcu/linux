...
DEFINE_STATIC_SRCU_FAST_UPDOWN(srcu_fastud_refctl_scale);
...
static bool srcu_fastud_sync_scale_init(void)
{
	srcu_ctlp = &srcu_fastud_refctl_scale;
	return true;
}

static void srcu_fastud_ref_scale_read_section(const int nloops)
{
	int i;
	struct srcu_ctr __percpu *scp;
...
static void srcu_fastud_ref_scale_delay_section(const int nloops, const int udl, const int ndl)
{
	int i;
	struct srcu_ctr __percpu *scp;
...
static const struct ref_scale_ops srcu_fastud_ops = {
	.init		= srcu_fastud_sync_scale_init,
	.readsection	= srcu_fastud_ref_scale_read_section,
	.delaysection	= srcu_fastud_ref_scale_delay_section,
...
ref_scale_init(void)
{
	...
	static const struct ref_scale_ops *scale_ops[] = {
		&rcu_ops, &srcu_ops, &srcu_fast_ops, &srcu_fastud_ops,
